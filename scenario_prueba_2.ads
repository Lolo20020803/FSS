...
package Scenario_V2 is
    ...
    Distance_Simulation: tipo_Secuencia_Distancia :=  -- next sample every 100ms.
            ( 5555,5555,5555,5555,5555, 5555,5555,5555,5555,5555,   -- 1s.
              ...
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 3s.
              1000,1000,1000,1000,1000, 1000,1000,1000,1000,1000,   -- 4s.
              ...
              5000,5000,5000,5000,5000, 5000,5000,5000,5000,5000,   -- 8s.
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 9s.
              ...
              5000,5000,5000,5000,5000, 5000,5000,5000,5000,5000,   -- 13s.
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 14s.
              ...
              5000,5000,5000,5000,5000, 5000,5000,5000,5000,5000,   -- 18s.
              3000,3000,3000,3000,3000, 3000,3000,3000,3000,3000,   -- 19s.
    ...
    Light_Intensity_Simulation: tipo_Secuencia_Light :=  -- 1 muestra cada 100ms.
                 ( 700,700,700,700,700, 700,700,700,700,700,   -- 1s.
                   ...
                   500,500,500,500,500, 500,500,500,500,500,   -- 8s.
    ...
    Joystick_Simulation: tipo_Secuencia_Joystick :=  -- 1 muestra cada 100ms.
                ((+50,+35),(+50,+35),(+50,+35),(+50,+35),(+50,-45),  
                 (+50,+35),(+50,+35),(+50,+35),(+50,+35),(+50,-35),  --1s.Subida brusca
 
                 (+50,+35),(+50,+35),(+50,+35),(+50,+35),(+50,-35),  
                 (+50,+35),(+50,+35),(+50,+35),(+50,+35),(+50,-35),  --2s. Subida brusca
                 ...
                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  
                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  --16s. descenso brusco
 
                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  
                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  --17s. descenso brusco

                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  
                 (+00,+00),(+00,+00),(+00,+00),(+00,+00),(+00,-00),  --18s. descenso brusco
    ...
    Power_Simulation: tipo_Secuencia_Power :=  -- next sample every 100ms.
                 ( 300,300,300,300,300, 300,300,300,300,300,   -- 1s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 2s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 3s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 4s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 5s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 6s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 7s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 8s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 9s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 10s.
                   ...
                   300,300,300,300,300, 300,300,300,300,300,   -- 15s.
                   300,300,300,300,300, 300,300,300,300,300,   -- 16s.
